...
const Language = () => {
    ...
    return (
        <div className='custom-dropdown' onClick={() => setIsMenuOpen(!isMenuOpen)}>
            <button className='custom-dropdown-toggle flex border-0 btnText fw-semibold fs-4 bg-transparent items-center justify-center'>
                <p>{languageText}</p>
            </button>
            {
                isMenuOpen && (
                    <div className="custom-dropdown-menu position-absolute d-flex flex-column align-items-center gap-1">
                        <div className="custom-dropdown-item bg-white py-1 px-2"
